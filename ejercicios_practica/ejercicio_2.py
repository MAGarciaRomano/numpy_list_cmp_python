...
if __name__ == '__main__':
    ...
    palabra_len = len_string('comprobación')
    print('La palabra comprobación tiene', palabra_len, 'caracteres.')
    ...
    for p in range(3):
        print('La palabra', palabras[p], 'tiene', palabras_len[p], 'caracteres.')
