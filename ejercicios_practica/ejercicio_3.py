...
if __name__ == '__main__':
    ...
    print('Lista de números naturales del 0 al 10.')
    print(lista_0_10)
    ...
    print('Lista con los primeros 11 múltiplos naturales de 5.')
    print(tabla_5)
    ...
    print('Lista con 10 números de días aleatorios de un mes.')
    print(dias_mes)
